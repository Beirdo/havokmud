...
struct spell_info_type spell_info[] = {
    ...
    { 63, cast_animate_dead, 5, 12, POSITION_STANDING, 
      IMMORTAL, 8, IMMORTAL, IMMORTAL, IMMORTAL, IMMORTAL, IMMORTAL, 5,
      TAR_OBJ_ROOM, 0, 0 },
    ...
    { 128, cast_commune, 10, 24, POSITION_STANDING, 
      ...
      TAR_IGNORE, 0, 1 },
    { 129, cast_animal_summon, 15, 24, POSITION_STANDING, 
    ...
    { 338, cast_chillshield, 40, 24, POSITION_STANDING,
      ...
      TAR_IGNORE, 0, 0 },
    { 339, mind_use_wall_of_thought, 50, 24, POSITION_STANDING,
      IMMORTAL, IMMORTAL, IMMORTAL, IMMORTAL, IMMORTAL, IMMORTAL, 30, IMMORTAL,
      TAR_SELF_ONLY | TAR_CHAR_ROOM, 30, 0 },
