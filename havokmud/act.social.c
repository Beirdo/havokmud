...
/* Not quite sure what i'm doing here yet but lets hope that this will be OOC socials
 * @date February 8th, 2004
 * @auth: Greg Hovey (Banon)
 * @param: Character, arguments..
 * @desc: OOC socials
 */
...
argument++;//[0]=' '; //take out the %
half_chop(argument,buf,name); //  only_argument(argument, buf);
...
*/
 ...
 if (!*name)    { /* No arguments */
    	...
    	if(action->others_no_arg) {
            ...
            } else { /*need an argument for this one*/
