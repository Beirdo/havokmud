...
dlog("in do_stat");
	...
	if (!*arg1) {
		...
		if ((k = get_char_vis_world(ch, arg1, &count))!=NULL){
			...
			ch_printf(ch,"%sRemort Class: %s%s%s.\n\r", color1, color2, class_names[k->specials.remortclass-1], color1);
...
/* New @ help - 9-30-01 - Mythos */
	...
	"lev - Level (only sets Mage level, use advance for other classes)\n\r"
	"sex - Sex  0 = Neutral   1 = Male   2 = Female\n\r"
	"race - Race of character or mob.  Use 'help allrace' for listing\n\r"
	...
	"age - Age of PC.  Postive numbers will add to age.  Negative will subtract.\n\r"
	"prac - Number of Practices\n\r"
	"str - Strength of PC\n\r"
	"add - Strength Modifier (ie 18/75 using this one could change the 75)\n\r"
	"saves - Saving throws (doesn't work)\n\r"
	"skills - how learned a skill is. @ skills <target> <skill number> <level> - See allspells for skill and spell list.\n\r"
	"stadd - Strength Modifier (ie 18/75 using this one could change the 75)\n\r"
	"int - Intelligence\n\r"
	"wis - Wisdom\n\r"
	"dex - Dexterity\n\r"
	"con - Constitution\n\r"
	...
	"known - Make spell or skill known to PC.  @ known <target> <skill number> - See allspells for listing.\n\r"
	...
	"objedit - Enable or Disable an Immortals ability to edit objects.\n\r"
	"mobedit - Enable or disable an Immortals ability to edit mobiles.\n\r"
	"remaffect - Remove all affects from target.\n\r"
	"wizreport - Set wizreport flag on target.\n\r"
	"nofly - Flag target as not being able to fly.\n\r"
	"wingsburn - Flag target as not being able to fly.  Burns wings of winged mobiles/PCs.\n\r"
...
send_to_char("@\n\r"
	...
	"\n\r"
	"align class exp lev sex race hunger thirst zone hit mhit tohit todam\n\r"
	...
	"numatks objedit mobedit remaffect wizreport nofly wingsburn move mmove\n\r"
	"Remember, be careful how you use this command!\n\r",ch);
      return;
    }
				...
				//VNUM; NAME; TYPE; FLAGS; Affect1; Affect2; Affect3; Affect4
					...
					switch (GET_ITEM_TYPE(obj)) {
						...
						case ITEM_WEAPON :
							...
							break;
						case ITEM_ARMOR :
							sprintf(buf, "AC-apply: %d,",obj->obj_flags.value[0]);
							append_to_string_block(&sb, buf);
...
if (IS_NPC(ch))
 ...
 if (!*arg) {
  ...
  send_to_char("interven <portal|summon|astral|locobj|zonelocate|kill|logall|eclipse|dns|color|wizlock|nopoly|req|rp|worldarena|deinit|tweak>\n\r",ch);
  return;
 }
